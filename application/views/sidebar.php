   ...
   <div class="sidebar">
      <nav class="mt-2">
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php if(userpermission('lr_vech_list') || userpermission('lr_vech_add') || userpermission('lr_vech_group')) { ?>
            ...
            <?php } ?>
            <?php if(userpermission('lr_trips_list') || userpermission('lr_trips_add') || userpermission('lr_trips_list_E')) { ?>
            <li class="nav-item has-treeview <?php echo ((activate_menu('trips'))=='active') ? 'menu-open':'' ?> <?php echo ((activate_menu('trips1'))=='active') ? 'menu-open':'' ?>
               ...
               <a href="#" class="nav-link <?php echo activate_menu('trips');?> <?php echo activate_menu('trips1');?> <?php echo activate_menu('addtrips');?> <?php echo activate_menu('edittrip');?><?php echo activate_menu('details');?>">
               ...
               <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                   ...
                   <?php } ?>
                   <?php if(userpermission('lr_trips_list_E')) { ?>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>trips/index2" class="nav-link <?php echo activate_menu('trips1');?><?php echo activate_menu('edittrip');?><?php echo activate_menu('details');?>">
                        <i class="nav-icon fas faa-list"></i>
                        <p>Pedidos Empresa</p>
                     </a>
                  </li>
            ...
            <li class="nav-item has-treeview <?php echo ((activate_menu('customer'))=='active') ? 'menu-open':'' ?>
               ...
               <ul class="nav nav-treeview">
                <?php  if(userpermission('lr_cust_list')) { ?>
                  ...
                  <?php } ?>
                  <?php  if(userpermission('lr_cust_list_E')) { ?>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>customer" class="nav-link <?php echo activate_menu('customer');?><?php echo activate_menu('editcustomer');?>">
                        <i class="nav-icon fas faa-list"></i>
                        <p>Customer Management</p>
