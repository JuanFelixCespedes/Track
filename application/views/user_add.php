                ...
                <div class="card-body">
                  ...
                  <div class="row">
                      ...
                      <div class="form-group mr-3">
                       ...
                       <div class="form-group mr-3">
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" value="1" <?php if(isset($userdetails[0]['lr_vech_list'])) { echo ($userdetails[0]['lr_trips_list_E']==1 ? 'checked' : ''); } ?> name="permissions[lr_trips_list_E]" class="custom-control-input" id="lr_trips_list_E">
                          <label class="custom-control-label" for="lr_trips_list_E">Pedidos Empresa</label>
                        </div>
                      </div>
                      <div class="form-group mr-3">
                        <div class="custom-control custom-checkbox">
                  ...
                  <div class="row">
                      ...
                      <div class="form-group mr-3">
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" value="1" <?php if(isset($userdetails[0]['lr_vech_list'])) { echo ($userdetails[0]['lr_cust_list_E']==1 ? 'checked' : ''); } ?> name="permissions[lr_cust_list_E]" class="custom-control-input" id="lr_cust_list_E">
                          <label class="custom-control-label" for="lr_cust_list_E">Cliente Empresa</label>
                        </div>
                      </div>
                      <div class="form-group mr-3">
                        <div class="custom-control custom-checkbox">
